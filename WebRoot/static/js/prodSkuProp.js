...
function getEnumData(pordPropId){
	...
	$.post(root+"/prodprop/searchSkuEnum", {"pordPropId":pordPropId},
			...
			for(var i in jsonObjArr){
				html = html + "<tr><td style='width:35.8% '><p title='"+jsonObjArr[i].prodPropEnum+"' style='width:100px; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;'>"+jsonObjArr[i].prodPropEnum+"</p></td><td style='width:31%'>"+jsonObjArr[i].seq+"</td>" +
				       "<td style='width:35%'>"
