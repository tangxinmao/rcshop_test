...
if(index==1&&!$('#couponDetailForm input[name="merchantId"]:checked').val()){
	alertWarn('Store'+' can\'t be empty.');
	return;
}
...
/*    $( '#couponDetailForm input[name="effectTime"]' ).datetimepicker({showSecond:true,showButtonPanel:true,changeMonth : true,dateFormat:"yy-mm-dd",timeFormat: "HH:mm:ss",
        ...
        onClose: function( selectedDate ) {
            ...
            $( '#couponDetailForm input[name="expireTime"]' ).datetimepicker( "option", "minDate", selectedDate );
        }
    });
    $( '#couponDetailForm input[name="expireTime"]' ).datetimepicker({showSecond:true,
        ...
        onClose: function( selectedDate ) {
            //$( "#date1" ).datepicker( "option", "minDate", selectedDate );
            $( '#couponDetailForm input[name="effectTime"]' ).datetimepicker( "option", "maxDate", selectedDate );
        }
    });*/
